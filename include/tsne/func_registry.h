...
tsne_func_t tsne_baseline, tsne_scalar, tsne_vec;
...
grad_desc_func_t grad_desc_baseline, grad_desc_ndim_unroll, grad_desc_mean_unroll, grad_desc_tmp_opt, grad_desc_loop_merge,
    grad_desc_accumulators2, grad_desc_accumulators, grad_desc_vec_bottom, grad_desc_vectorized;
